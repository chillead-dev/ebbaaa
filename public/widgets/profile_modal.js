      ...
      <div class="panel" style="margin:0">
        <div class="row" style="cursor:default;margin:0;padding:10px;background:transparent">
          ...
          <div class="mid">
            ...
            ${peer.verified?`<div class="sub" style="margin-top:10px;color:var(--accent);display:flex;align-items:center;gap:8px"><span class="vbadge" style="width:18px;height:18px"><svg viewBox="0 0 24 24"><path d="M12 2l3 3 4 .5-1.5 3.7 1.5 3.7-4 .5-3 3-3-3-4-.5 1.5-3.7L5 5.5 9 5l3-3z" fill="currentColor" opacity=".28"/><path d="M9.2 12.2l1.7 1.7 4.1-4.1" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg></span><span class="vText" data-i18n="verified_note">This profile has been verified by Exuberant</span></div>`:""}
          </div>
        </div>
