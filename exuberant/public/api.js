const API = {
  ...
  signup(email,password,code,username){ return this.call("auth_signup", { email,password,code,username }); },
  ...
  postsList(token, cursor){ return this.call("posts_list", { cursor }, token); },
